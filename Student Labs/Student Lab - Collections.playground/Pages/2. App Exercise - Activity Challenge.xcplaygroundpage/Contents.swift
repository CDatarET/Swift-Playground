 ...
 */
var list1: [String] = ["walk 3 miles a day", "run 5 times a week", "climb a mountain", "go hiking"]
var list2: [String] = ["solve easy leetcode problem", "solve medium leetcode problem", "solve hard leetcode problem"]
print(list1)
print(list2)
...
var challenges: [[String]] = [list1, list2]
...
var completedChallenges: [String] = ["run 5 times a week", "solve medium leetcode problem"]
