...
let favoriteBook = Book(title: "The Blackthorn Key", author: "Kevin Sands", pages: 371, price: 1685)
...
let thinkpad = Laptop(yearPurchased: 2020)
let macbook = Laptop(yearPurchased: 2026)
/*:
